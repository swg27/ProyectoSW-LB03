...
$preguntas = simplexml_load_file('../../../.back-end/xml/preguntas.xml');
...
$respuestasIncorrecta = $assessmentItem -> addChild('value', $incorrectAns1);
$respuestasIncorrecta = $assessmentItem -> addChild('value', $incorrectAns2);
$respuestasIncorrecta = $assessmentItem -> addChild('value', $incorrectAns3);
$preguntas->asXML('../../../.back-end/xml/questions.xml');
